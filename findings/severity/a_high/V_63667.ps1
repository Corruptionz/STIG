...
$STIG = Test-RegistryValue -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\Explorer\' -ValueName 'NoAutoplayfornonVolume' -Value '1'
...
if($STIG -eq 0) {
    ...
    Set-ItemProperty -Path 'HKLM:\SOFTWARE\Policies\Microsoft\Windows\Explorer\' -Name 'NoAutoplayfornonVolume' -Type 'DWORD' -Value '1' -Force | Out-Null
